...
class Tests(TestCase):
    ...
    def test_multiple_random_events(self):
        self.assertEqual(0, prob.multiple_random_events([], [], True))
        self.assertEqual(0, prob.multiple_random_events([], [1], True))
        self.assertEqual(1, prob.multiple_random_events([1], [1], True))
        self.assertEqual(0, prob.multiple_random_events([1, 3], [1, 2], True))
        self.assertEqual(1, prob.multiple_random_events([1, 1], [1], True))
        self.assertEqual(0, prob.multiple_random_events([1, 1], [1], False))
        self.assertEqual(0.2222222222222222,
                         prob.multiple_random_events([1, 0], [1, 0, 1], True))
        ...
        self.assertEqual(0.25,
                         prob.multiple_random_events([None, 'hi'], ['hi', None], True))
