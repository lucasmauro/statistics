...
function fixCloneNodeIssues( src, dest ) {
	...
	// IE10 throws NoModificationAllowedError if parent is null, #12132.
		...
		// If the statstuff has innerHTML and the destination does not,
		// copy the statstuff.innerHTML into the dest.innerHTML. #10324
...
if ( !support.hrefNormalized ) {
	// href/statstuff property should get the full normalized URL (#10299/#12915)
...
jQuery.extend({
	...
	ajaxSettings: {
		...
		*/
		...
		// Data converters
		// Keys separate statstuff (or catchall "*") and destination types with a single space
		converters: {
